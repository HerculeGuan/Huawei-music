...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"javascript.e800b749.js":[function(require,module,exports) {
var define;
...
parcelRequire = function (e, r, t, n) {
  ...
  "1+OC": [function (require, module, exports) {
    ...
    var n = function n(e) {
      if (t(this, n), !e) throw new Error("需要传递需要绑定的DOM元素");
      var o,
          i,
          r,
          c = "string" == typeof e ? document.querySelector(e) : e,
          u = {
        swipLeft: [],
        swipRight: []
      };
      c.ontouchstart = function (t) {
        ...
        r && clearInterval(r), r = setTimeout(function () {
          (i = t.changedTouches[0].pageX) - o > 50 ? u.swipRight.forEach(function (t) {
            return t.bind(c)();
          }) : o - i > 50 && u.swipLeft.forEach(function (t) {
            return t.bind(c)();
          });
        }, 100);
  ...
  "EWR2": [function (require, module, exports) {
    ...
    var r = function () {
      function e(t) {
        var n = this;
        i(this, e), this.root = "string" == typeof t ? document.querySelector(t) : t, this.$ = function (t) {
          return n.root.querySelector(t);
        }, this.$$ = function (t) {
          return n.root.querySelectorAll(t);
        }, this.songList = [], this.currentIndex = 0, this.audio = new Audio(), this.lyricsArr = [], this.lyricIndex = -1, this.start(), this.bind();
      }
      ...
      return s(e, [{
        ...
        value: function value() {
          var t = this;
          fetch("https://sherltiangang.github.io/music-list/Huawei-music/music-list.json").then(function (t) {
            return t.json();
          }).then(function (e) {
            console.log(e), t.songList = e, t.renderSong();
          });
        }
      }, {
        key: "bind",
        value: function value() {
          ...
          this.$(".btn-pause").onclick = function () {
            this.classList.contains("playing") ? (e.audio.pause(), this.classList.remove("playing"), this.classList.add("pause"), this.querySelector("use").setAttribute("xlink:href", "#icon-play")) : this.classList.contains("pause") && (e.audio.play(), this.classList.remove("pause"), this.classList.add("playing"), this.querySelector("use").setAttribute("xlink:href", "#icon-pause")), console.log(e.audio);
          }, this.$(".btn-pre").onclick = function () {
            e.$(".btn-pause>use").setAttribute("xlink:href", "#icon-pause"), e.currentIndex = (e.songList.length + e.currentIndex - 1) % e.songList.length, e.renderSong(), e.playSong();
          }, this.$(".btn-next").onclick = function () {
            e.$(".btn-pause>use").setAttribute("xlink:href", "#icon-pause"), e.currentIndex = (e.currentIndex + 1) % e.songList.length, e.renderSong(), e.playSong();
          }, this.$(".bar").onclick = function (t) {
            var i = t.offsetX / parseInt(getComputedStyle(this).width);
            e.audio.currentTime = e.audio.duration * i;
          }, this.$(".btn-circle").onclick = function () {
            this.classList.contains("no-circle") ? (e.audio.loop = !0, this.classList.remove("no-circle"), this.classList.add("is-circle")) : this.classList.contains("is-circle") && (e.audio.loop = !1, this.classList.remove("is-circle"), this.classList.add("no-circle")), console.log("loop"), e.loopSong();
          }, this.audio.ontimeupdate = function () {
            console.log(parseInt(1e3 * e.audio.currentTime)), e.locateLyric(), e.setProgerssBar();
          }, this.audio.onended = function () {
            e.$(".btn-pause>use").setAttribute("xlink:href", "#icon-pause"), e.currentIndex = (e.currentIndex + 1) % e.songList.length, e.renderSong(), e.playSong();
          };
          var i = new t.default(this.$(".container"));
          i.on("swipLeft", function () {
            console.log(this), this.classList.remove("panel1"), this.classList.add("panel2"), e.$(".ball-left").classList.remove("current"), e.$(".ball-right").classList.add("current");
          }), i.on("swipRight", function () {
            console.log(this), this.classList.remove("panel2"), this.classList.add("panel1"), e.$(".ball-right").classList.remove("current"), e.$(".ball-left").classList.add("current");
          });
        }
      }, {
        key: "renderSong",
        value: function value() {
          var t = this,
              e = this.songList[this.currentIndex];
          this.$(".header h1").innerText = e.title, this.$(".header p").innerText = e.author + "-" + e.albumn, this.audio.src = e.url, this.audio.onloadedmetadata = function () {
            return t.$(".time-end").innerText = t.formateTime(t.audio.duration);
          }, this.loadLyrics();
        }
      }, {
        key: "playSong",
        ...
        value: function value() {
          var t = this;
          fetch(this.songList[this.currentIndex].lyric).then(function (t) {
            return t.json();
          }).then(function (e) {
            console.log(e.lrc.lyric), t.setLyrics(e.lrc.lyric), window.lyrics = e.lrc.lyric;
          });
        }
      }, {
        key: "locateLyric",
        value: function value() {
          if (console.log("locateLyric"), 1e3 * this.audio.currentTime > this.lyricsArr[this.lyricIndex + 1][0] && this.lyricIndex < this.lyricsArr.length - 2) {
            this.lyricIndex++;
            var t = this.$('[data-time="' + this.lyricsArr[this.lyricIndex][0] + '"]');
            t && this.setLineToCenter(t), this.$$(".panel-effect .lyrics p")[0].innerText = this.lyricsArr[this.lyricIndex][1], this.$$(".panel-effect .lyrics p")[1].innerText = this.lyricsArr[this.lyricIndex + 1] ? this.lyricsArr[this.lyricIndex + 1][1] : "";
          }
        }
      }, {
        key: "setLineToCenter",
        value: function value(t) {
          var e = t.offsetTop - this.$(".panel-lyrics").offsetHeight / 2;
          e = e > 0 ? e : 0, this.$(".panel-lyrics .lyrics-box").style.transform = "translateY(-".concat(e, "px)"), this.$$(".panel-lyrics p").forEach(function (t) {
        ...
        value: function value(t) {
          ...
          var e = document.createDocumentFragment(),
              i = [];
          this.lyricsArr = i, t.split(/\n/).filter(function (t) {
            return t.match(/\[.+?\]/);
          }).forEach(function (t) {
            var e = t.replace(/\[.+?\]/g, "");
            t.match(/\[.+?\]/g).forEach(function (t) {
              t = t.replace(/[\[\]]/g, "");
              var n = 60 * parseInt(t.slice(0, 2)) * 1e3 + 1e3 * parseInt(t.slice(3, 5)) + parseInt(t.slice(6));
              i.push([n, e]);
            });
          }), i.filter(function (t) {
            return "" !== t[1].trim();
            ...
            i.setAttribute("data-time", t[0]), i.innerText = t[1], e.appendChild(i);
          }), this.$(".container .lyrics-box").innerHTML = "", this.$(".container .lyrics-box").appendChild(e);
        }
      }, {
        key: "formateTime",
        value: function value(t) {
          ...
          e = e >= 10 ? "" + e : "0" + e;
          var i = parseInt(t % 60);
          return e + ":" + (i = i >= 10 ? "" + i : "0" + i);
        }
      }, {
        key: "setProgerssBar",
        value: function value() {
          console.log("set setProgerssBar");
          var t = 100 * this.audio.currentTime / this.audio.duration + "%";
          console.log(t), this.$(".bar .progress").style.width = t, this.$(".time-start").innerText = this.formateTime(this.audio.currentTime), console.log(this.$(".bar .progress").style.width);
        }
      }]), e;
    }();

    window.a = new r("#player");
  }, {
    "./icons.js": "MUcg",
    "./swiper.js": "1+OC"
  }]
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","javascript.e800b749.js"], null)
//# sourceMappingURL=/javascript.e800b749.79ea29b9.js.map