...
function () {
  ...
  _createClass(player, [{
    ...
    value: function start() {
      ...
      fetch('https://sherltiangang.github.io/music-list/Huawei-music/music-list.json').then(function (response) {
    ...
    value: function bind() {
      ...
      var swiper = new _swiper.default(this.$('.container'));
    ...
    value: function loadLyrics() {
      ...
      fetch(this.songList[this.currentIndex].lyric).then(function (response) {
        return response.json();
      }).then(function (data) {
    ...
    value: function setLineToCenter(node) {
      ...
      this.$('.panel-lyrics .lyrics-box').style.transform = "translateY(-".concat(offset, "px)");
